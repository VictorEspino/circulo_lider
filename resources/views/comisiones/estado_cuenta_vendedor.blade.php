    ...
    <div class="p-6 flex flex-col w-full text-gray-700  px-2 md:px-8">
        ...
        <div class="w-full flex flex-col">
            ...
            <div class="w-full flex flex-row pt-3 space-x-5">
                ...
                <div class="w-1/3 flex flex-col bg-gradient-to-br from-black to-slate-500 text-white rounded-lg py-3 px-3">
                    <div class="flex flex-col md:flex-row lg:flex-row">
                        <div class="w-5/6 font-bold">Volumen de Ventas</div>
                        <div class="text-sm font-bold"></div> 
                    </div> 
                    <div class="text-3xl font-bold flex justify-end text-orange-500">{{number_format($medicion->ventas,0)}}</div>
                    <div class="flex flex-row">
                        <div class="font-bold text-xs">Cuentan las ACTIVACIONES de planes Simple y Armalo</div> 
                    </div>
                </div>
                <div class="w-1/3 flex flex-col bg-gradient-to-br from-black to-slate-500 text-white rounded-lg py-3 px-3">
                    <div class="flex flex-col md:flex-row lg:flex-row">
            ...
            <div class="w-full flex flex-row pt-3 space-x-5">
                ...
                <div class="w-1/2 flex flex-col bg-gradient-to-br from-orange-400 to-black text-white rounded-lg py-3 px-3">
                    <div class="flex flex-col md:flex-row lg:flex-row">
                        <div class="w-5/6 font-bold">Rentas promedio</div>
                        <div class="text-sm font-bold"></div> 
                    </div> 
                    <div class="text-3xl font-bold flex justify-end">${{number_format($medicion->ventas>0?($medicion->rentas*1.16*1.03)/$medicion->ventas:0,0)}}</div>
                    <div class="flex flex-col">
                        <div class="font-bold text-xs">
                            El objetivo del esquema de comision es premiarte por impulsar una mayor renta en las ventas de planes, impula principalmente la venta de planes ARMALO 5GB, cuando el cliente tenga interes de compra en planes ARMALO de 2GB y 3GB
                        </div> 
                    </div>
                </div>
            </div>
