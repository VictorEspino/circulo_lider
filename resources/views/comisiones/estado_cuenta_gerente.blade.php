    ...
    <div class="p-6 flex flex-col w-full text-gray-700  px-2 md:px-8">
        ...
        <div class="w-full flex flex-col">
            ...
            <div class="w-full flex flex-row pt-3 space-x-5">
                ...
                <div class="w-1/3 flex flex-col bg-gradient-to-br from-black to-slate-500 text-white rounded-lg py-3 px-3">
                    <div class="flex flex-col md:flex-row lg:flex-row">
                        <div class="w-5/6 font-bold">Plantilla Autorizada</div>
                        <div class="text-sm font-bold">{{$medicion->plantilla_autorizada}}</div> 
                    </div> 
                    <div class="w-full flex flex-row pt-5">
                    ...
                    <div class="w-full flex flex-row">
                        <div class="w-1/6 text-xs"></div>
                        <div class="w-1/2 text-xs"> Productiva</div>
                        <div class="w-1/6 text-xs font-bold">{{$medicion->ejecutivos_productivos}}</div>
                        <div class="w-1/6 text-base font-bold">
                            @if($medicion->ejecutivos_productivos>=$medicion->plantilla_autorizada)
            ...
            <div class="w-full flex flex-row pt-3 space-x-5">
                <div class="w-full flex flex-col bg-gradient-to-br from-orange-400 to-black text-white rounded-lg py-3 px-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="font-bold text-xs">
                            Necesitas lograr al menos el 50% de tu cuota con estas ventas, para obtener la llave de acceso a comisiones de activaciones y servicios adicionales.
                        </div>
                        <div class="font-bold text-xs pt-3">
                            Aceleradores:
                        </div> 
                        <div class="font-normal text-xs">
                            1) Logra al menos el 80% de tu cuota y cubre el total de tu plantilla de vendedores, esto tambien te permite acceder al ACELERADOR DE RENOVACIONES.
                        </div> 
                        <div class="font-normal text-xs">
                            2) Logra el 100% de tu cuota y cubre el total de tu plantilla de vendedores.
                        </div> 
                        <div class="font-normal text-xs">
                            3) Logra el 100% de tu cuota, cubre el total de tu plantilla y logra que TODOS los vendedores de tu plantilla logren su productividad minima.
                        </div> 
                    </div>
                </div>
