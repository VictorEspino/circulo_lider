<x-app-layout>
    <x-slot name="header">
            {{ __('Encuesta en zona de influencia') }}
    </x-slot>
    <form method="post" action="{{route('zona_influencia_nuevo')}}">
        ...
        <div class="w-full rounded-b-lg bg-white p-3 flex flex-col"> <!--CONTENIDO-->
            <div class="w-full flex flex-row space-x-2">
                <div class="w-1/2">
                    ...
                    <input class="w-full rounded p-1 border border-gray-300" type="text" name="nombre_contacto" value="{{old('nombre_contacto')}}" id="np">
                ...
                <div class="w-1/4">
                    <span class="text-xs">Compañia</span><br>
                    <input class="w-full rounded p-1 border border-gray-300" type="text" name="compania" value="{{old('compania')}}">
                    @error('compania')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
                </div>
            ...
            <div class="w-full flex flex-row space-x-2">
                <div class="w-1/3">
                    <span class="text-xs">Tipo plan</span><br>
                    <input class="w-full rounded p-1 border border-gray-300" type="text" name="tipo_plan" value="{{old('tipo_plan')}}">
                    @error('tipo_plan')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
                </div>
                <div class="w-1/3">
                    <span class="text-xs">¿Cuanto gasta al mes?</span><br>
                    <input class="w-full rounded p-1 border border-gray-300" type="text" name="gasto_mes" value="{{old('gasto_mes')}}">
                    @error('gasto_mes')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
                </div>
                <div class="w-1/3">
                    ...
                    <input class="w-full rounded p-1 border border-gray-300" type="text" name="equipo_zona" value="{{old('equipo_zona')}}">
                    @error('equipo_zona')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
                </div>
            ...
            <div class="w-full flex flex-row space-x-2">
                <div class="w-full">
                    <span class="text-xs">Beneficios de su plan</span><br>
                    <textarea class="w-full rounded p-1 border border-gray-300" name="beneficios">{{old('beneficios')}}</textarea>
                    @error('beneficios')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
                </div>
            ...
            <div class="w-full flex flex-row space-x-2">
                <div class="w-1/3">
                    <span class="text-sm font-bold text-red-400">Resultado encuesta</span><br>
        ...
        <div class="w-full rounded-b-lg bg-white p-3 flex flex-col"> <!--CONTENIDO-->
            <div class="w-full flex flex-row space-x-2">
                ...
                <div class="w-2/3">
                    ...
                    <input class="w-full rounded p-1 border border-gray-300" type="text" name="funnel_nombre" value="{{old('funnel_nombre')}}" id="nf">
                    @error('funnel_nombre')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
                </div>
        ...
        <div class="w-full rounded-b-lg bg-white p-3 flex flex-col"> <!--CONTENIDO-->
            <div class="w-full flex flex-row space-x-2">
                <div class="w-1/3">
                    ...
                    <select class="w-full rounded p-1 border border-gray-300" type="text" name="origen">                       
                        <option value="ZONA INFLUENCIA" class="" {{old('origen')=="ZONA INFLUENCIA"?'selected':''}}>ZONA INFLUENCIA</option>
                    </select>    
                    @error('origen')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
            ...
            <div class="w-full flex flex-row space-x-2">
                <div class="w-1/2">
                    <span class="text-xs">Telefono Cliente</span><br>
                    <input class="w-full rounded p-1 border border-gray-300" type="text" name="orden_telefono" value="{{old('orden_telefono')}}">
...
<!--        <form method="post" action="{{route('orden_nuevo')}}">
            ...
            <div class="w-full flex flex-col space-x-0 space-y-2 md:flex-row md:space-x-2 md:space-y-0">
                <div class="w-full md:w-1/2">
                    ...
                    <x-jet-input type="text" class="w-full" name="cliente" value="{{old('cliente')}}" id="no"></x-jet-input>
                    @error('cliente')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                    
            ...
            <div class="w-full flex flex-col space-x-0 space-y-2 md:flex-row md:space-x-2 md:space-y-0">
                ...
                <div class="w-full md:w-1/4">
                    ...
                    <x-jet-input type="text" class="w-full" name="dn" value="{{old('dn')}}" id="to"></x-jet-input>
                    @error('dn')
                      <br><span class="text-xs italic text-red-700 text-xs">{{ $message }}</span>
                    @enderror                                     
                </div>
    ...
    <script>
        function show_funnel()
        {
            ...
            if(valor=="Funnel")
            {
                ...
                document.getElementById("nf").value=document.getElementById("np").value
            ...
            if(valor=="Venta")
            {
                ...
                document.getElementById("no").value=document.getElementById("np").value
