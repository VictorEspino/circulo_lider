<x-app-layout>
    ...
    <div class="p-10 flex flex-col w-full text-gray-700  px-2 md:px-8">
        <div class="w-full rounded-t-lg bg-slate-300 p-3 flex flex-col border-b border-gray-800"> <!--ENCABEZADO-->
            <div class="w-full text-lg font-semibold">Importar archivo CIS POSPAGO</div>
        ...
        <form method="post" action="{{route('carga_cis_pospago')}}" enctype="multipart/form-data">
            @csrf
