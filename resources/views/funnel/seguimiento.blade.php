<x-app-layout>
    ...
    <div class="flex flex-col w-full px-5 text-gray-700 shadow-lg rounded-lg">
            ...
            <div class="w-full flex justify-center pt-5 flex-col"> <!--TABLA DE CONTENIDO-->
                ...
                <table>
                    <tr class="">
                        ...
                        <td class="border border-gray-300 font-semibold bg-slate-600 text-gray-200 p-1 text-sm"><center>Origen</td>
                        ...
                        <td class="border border-gray-300 font-semibold bg-slate-600 text-gray-200 p-1 text-sm"><center>Equipo</td>
                        <td class="border border-gray-300 font-semibold bg-slate-600 text-gray-200 p-1 text-sm"><center>Estatus</td>
                        <td class="border border-gray-300 font-semibold bg-slate-600 text-gray-200 p-1 text-sm"><center>Creacion</td>
                    </tr>
                <?php
                    $color=false;
                ...
                ?>
                    <tr class="">
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs"><center><a href="javascript:detalles({{$funnel->id}})"><i class="far fa-edit"></i></a></td>
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs">{{$funnel->nombre}}</td>
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs">{{$funnel->origen}}</td>
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs">{{$funnel->cliente}}</td>
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs">{{$funnel->plan}}</td>
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs">{{$funnel->equipo}}</td>
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs">{{$funnel->estatus}}</td>
                        <td class="border border-gray-300 font-light {{$color?'bg-orange-100':''}} text-gray-700 p-1 text-xs">{{$funnel->created_at}}</td>
                    </tr>
                <?php
                    $color=!$color;
                    }
            ...
            function guardar_detalles()
            {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                         ...
                         if(estatus=="Venta")
                         {
                             alert("Sera redirigido a la pantalla para completar la venta");
                             document.location.href="/ventas_nueva/"+origen+"/"+cliente+"/"+correo;
                         }
                         else
                         {
